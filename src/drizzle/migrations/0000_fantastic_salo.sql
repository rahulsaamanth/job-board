...
CREATE TYPE "public"."job_listing_application_stage" AS ENUM('denied', 'applied', 'interested', 'interviewing', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "user_notification_settings" (
	...
	"newJobListingNotifications" boolean DEFAULT false NOT NULL,
	"aiPrompt" varchar,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
